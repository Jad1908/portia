...
3. **The surface.** Six runs have been scored by hand off terminal transcripts, and the artifacts
   ...
   *follow-up*, not driving. This is the point where "the questions-and-insights UX is the product"
   stops being a claim in this document and becomes something we can sit in front of.
